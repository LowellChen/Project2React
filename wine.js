...
export default class wine extends React.Component {
  ...
  <img className="card-img-top" src="moscato.jpg" alt="Card image cap">
...
<div className="card" style="width: 18rem;">
  <img className="card-img-top" src="lafite.webp" alt="Card image cap">
  <div className="card-body">
...
<div className="card" style="width: 18rem;">
  <img className="card-img-top" src="matua.png" alt="Card image cap">
  <div className="card-body">
...
<div className="card" style="width: 18rem;">
  <img className="card-img-top" src="pinotnoir.webp" alt="Card image cap">
  <div className="card-body">
